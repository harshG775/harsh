...
function ProjectsCard({data}) {
    return (
		<div className="group relative min-h-[250px] max-w-md mx-auto bg-bg_2 grid place-items-center overflow-hidden rounded-md">
            ...
            <div className=" transition-transform duration-500 ease-in-out translate-y-28 group-hover:translate-y-0 grid grid-rows-[1fr_2fr] p-2 absolute bottom-2 left-2 right-2 rounded-md bg-bg_2">
